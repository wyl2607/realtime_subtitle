...
| Windows runbook | [`docs/zh/`](zh/WINDOWS-RUNBOOK.md) · [`docs/en/`](en/WINDOWS-RUNBOOK.md) · [`docs/de/`](de/WINDOWS-RUNBOOK.md) | all three, kept in sync |
| Desktop 操作说明.txt | [`docs/zh/user-guide-template.txt`](zh/user-guide-template.txt) | 中文 — generated by `install.ps1`, never edit the desktop copy |
